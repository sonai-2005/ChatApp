        ...
        {/* details section */}
         <div className="space-y-6">
            <div className="space-y-1.5">
              ...
              <p className="px-4 py-2.5 bg-base-200 rounded-lg border opacity-40">{authUser?.fullName}</p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <p className="px-4 py-2.5 bg-base-200 rounded-lg opacity-40 border">{authUser?.email}</p>
            </div>
